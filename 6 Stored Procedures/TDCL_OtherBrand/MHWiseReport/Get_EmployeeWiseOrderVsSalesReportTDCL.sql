...
SELECT
nat.NodeID NationalID, nat.Code NationalCode, nat.Name NationalName,
...
WHERE e.EntryModule=3  AND e.[Status] = 16 AND sp.SalesPointID IN (SELECT Id FROM @temSalesPointIDs)

GROUP BY
nat.NodeID, nat.Code, nat.Name, reg.NodeID, reg.Code, reg.Name,
area.NodeID, area.Code, area.Name, trei.NodeID, trei.Code, trei.Name,
sp.SalesPointID, sp.Code, sp.Name, OrderVsSales.SRID,
