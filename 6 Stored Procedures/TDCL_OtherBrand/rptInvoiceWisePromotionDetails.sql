...
(InvoiceID, InvoiceNo, InvoiceDate, SalesPointID, CustomerID, GrossValue, NetValue)
SELECT si.InvoiceID, si.InvoiceNo, si.InvoiceDate, si.SalesPointID, si.CustomerID, si.GrossValue, si.NetValue
...
(
	...
	c.Address1, c.OwnerName, c.ContactNo,SUM(sii.Quantity) Quantity, si.GrossValue, si.InvoiceDate, sp.OfficeAddress
