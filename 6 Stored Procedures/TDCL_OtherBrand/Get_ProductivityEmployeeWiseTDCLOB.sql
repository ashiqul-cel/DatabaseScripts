...
DECLARE @FromDate DATETIME = '1 Jan 2022', @ToDate DATETIME = '31 Jan 2022',
...
SELECT
MH.NationalName, MH.RegionName, MH.AreaName, MH.TerritoryName, MH.DBCode, MH.DBName, E.Code EmployeeCode, E.Name EmployeeName,
