...
A.InvoiceNo,A.TranDate InvoiceDate,A.Promotion, A.StartDate [From] ,A.EndDate [To], ISNULL(A.CompanyName, '') CompanyName, A.SlabNo TPSlabNo,
...
A.OutletCode,A.OutletName,A.InvoiceNo,A.TranDate,A.Promotion, A.StartDate ,A.EndDate,A.SlabNo,A.ChannelCode,A.ChannelName, A.CompanyName
