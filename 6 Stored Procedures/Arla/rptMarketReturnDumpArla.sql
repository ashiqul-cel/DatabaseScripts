...
--DECLARE @StartDate DATETIME = '1 Feb 2022', @EndDate DATETIME = '2 Feb 2022'
...
, SAR.Name [Reason], MRI.InvoicePrice, MRI.Quantity, (MRI.InvoicePrice * MRI.Quantity) [Value], CONVERT(DECIMAL(10,2), s.[Weight] * MRI.Quantity * 0.001) KG
