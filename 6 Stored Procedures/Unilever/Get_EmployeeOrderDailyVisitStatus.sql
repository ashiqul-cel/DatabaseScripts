...
--DECLARE @OrderDate DATETIME = '20 Dec 2021', @SalesPointID INT = 10, @EmployeeID INT = 15952, @RouteID INT = 13089, @SectionID INT = 59042
...
IF(ISNULL(@RptDataChecker, 0) > 0)
	BEGIN
		...
		LPC = (SELECT count(b.SKUID) FROM SalesOrdersRpt as a
