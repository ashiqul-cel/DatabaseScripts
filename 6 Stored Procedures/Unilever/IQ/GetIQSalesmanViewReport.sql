...
(
	...
	IIF(ROUND((X.EBTarget * X.EBThreshold * 0.01), 0) > 0, CAST((X.EBActual * 100) / ROUND((X.EBTarget * X.EBThreshold * 0.01), 0) AS DECIMAL(5, 2)), 0) [EB Achievement %],
	...
	IIF(ROUND((X.RedlineTarget * X.RedlineThreshold * 0.01), 0) > 0, CAST((X.RedlineActual * 100) / ROUND((X.RedlineTarget * X.RedlineThreshold * 0.01), 0) AS DECIMAL(5, 2)), 0) [Redline Achievement %],
	...
	IIF(ROUND((X.WPTarget * X.WPThreshold * 0.01), 0) > 0, CAST((X.WPActual * 100) / ROUND((X.WPTarget * X.WPThreshold * 0.01), 0) AS DECIMAL(5, 2)), 0) [WP Achievement %],
	...
	IIF(ROUND((X.NPDTarget * X.NPDThreshold * 0.01), 0) > 0, CAST((X.NPDActual * 100) / ROUND((X.NPDTarget * X.NPDThreshold * 0.01), 0) AS DECIMAL(5, 2)), 0) [NPD Achievement %],
