...
CREATE PROCEDURE [dbo].[rptTargetSummarySR]
...
,'DSR Name', 'Target Value','Target Pcs'
...
, CAST(SKUCode AS VARCHAR), CAST(SKUName AS VARCHAR), CAST(SRName AS VARCHAR), CAST(TargetValue AS VARCHAR), CAST(TargetPcs AS VARCHAR)
