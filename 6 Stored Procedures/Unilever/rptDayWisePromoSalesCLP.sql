...
CREATE PROCEDURE [dbo].[rptDayWisePromoSalesCLP]
@SalesPointIDs VARCHAR(5000), @StartDate DATETIME, @EndDate DATETIME, @DBID INT = 0, @ProgramType INT = 2, @ProgramID INT = 0
AS
SET NOCOUNT ON;
