...
SELECT      A.SectionID, A.SystemID, A.SubsystemID, A.SalesPointID, A.SRID, A.DeliverymanID, A.RouteID, 
			...
			C.Name AS DeliverymanName, D.Name AS RouteName, E.Name AS DeliveryGroupName, A.BanglaName, A.Code1 ,A.IsMultipleRoutes,
			SP.TownName, SP.Code DistributorCode
...
CREATE UNIQUE CLUSTERED INDEX [IX_View_Sections_Index] ON [dbo].[View_Sections_Index]
(
	[SectionID] ASC
)
